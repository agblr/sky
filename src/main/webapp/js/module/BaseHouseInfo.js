...
//						});
						...
						data.usename = container.find('.usename').val();
						data.mobile = container.find('.mobile').val();
						 data.phone = container.find('.phone').val();
						 data.gender = container.find('.gender').val();
						 data.qq = container.find('.qq').val();
						 data.wechat = container.find('.wechat').val();
						 data.email = container.find('.email').val();
						...
						$.extend(requestData, {
							...
							id: data.userId,
							usename : container.find('.usename').val(),
						    mobile : container.find('.mobile').val(),
						    phone : container.find('.phone').val(),
						    nickname : container.find('.nickname').val(),
						    qq : container.find('.qq').val(),
						    wechat : container.find('.wechat').val(),
						    email : container.find('.email').val(),
						    source : container.find('.source').val(),
						    status : container.find('.status').val(),
						    address : container.find('.address').val(),
						    remarks : container.find('.remarks').val()
						});
						ajaxPromise({
