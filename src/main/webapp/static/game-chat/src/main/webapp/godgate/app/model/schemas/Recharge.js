Ext.define('app.model.schemas.Recharge', {
    ...
    items: [
        ...
        {id: 'userIdText', type: 'string', name: '用户',width:140, allowBlank:false, queryable:true},
        {id: 'rechargetype', type: 'string', name: '充值类型',allowBlank:false,dic:'dic.chat.rechargeType',display:"0"},
