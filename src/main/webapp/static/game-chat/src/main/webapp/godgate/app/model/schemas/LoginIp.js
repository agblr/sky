Ext.define('app.model.schemas.LoginIp', {
    ...
    items: [
        ...
        {id: 'userId', type: 'string', name: '用户Id',allowBlank:false},
        {id: 'userName', type: 'string', name: '用户名',allowBlank:false,queryable:true},
        ...
        {id: 'realIp', type: 'string', name: '真实ip',width:120,queryable:true},
