...
<html lang="zh-CN">
	...
	<body>
		<header class="ui-page-header">
			<div class="mini-title">当前位置：发送公告</div>
		</header>
		...
		<div class="form-horizontal">
			...
			<div class="col-sm-8">
			<input class="createTime form-control form-date" type="text" value="${ func:formatDate(gameserver.creattime) }"  data-date-format="yyyy-mm-dd hh:ii:ss" />
			</div>
			</div>
			 <div class="form-group">
		...
		<script type="text/javascript">
			MX.load({
				...
				var el = $(this), validator = new Validator(), data = {};
							...
							ajaxPromise({
								url: window.basePath + 'tool/addGameAnnouncement',
								type: 'POST',
								data: data,
								dataType: 'json'
							}).then(function(data) {
								document.location.href = window.basePath + 'tool/announcementInfoList';
							}, function() {
