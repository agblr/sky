...
<link rel="stylesheet" href="<c:url value="/css/house/info_main.css"/>" />
</head>
<body>
	<!--=============================================================================================================================================================================-->
	<!--main-container-part-->
...
<script type="text/javascript" src="<c:url value="/js/house/jquery.min.js"/>"></script>
<script type="text/javascript" charset="utf-8" src="<c:url value="/js/house/script_user.js"/>"></script>
